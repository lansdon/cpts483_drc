...
const std::string MKEY_DB_PERSIST_MEDIATION_PROCESS_FORM_DONE = "MKEY_DB_PERSIST_MEDIATION_PROCESS_FORM_DONE";                // MediationProcess*
...
const std::string MKEY_DB_LOAD_MEDIATION_PROCESS_FORM_DONE = "MKEY_DB_LOAD_MEDIATION_PROCESS_FORM_DONE";                      // MediationProcess*
...
const std::string MKEY_DB_LOAD_PERSON_FORM_DONE = "MKEY_DB_LOAD_PERSON_FORM_DONE";                      // Person*
...
//////////////////////////////////////////////////////////////////                              ARGUMENT TYPE
const std::string MKEY_GUI_QUERY_PERSON = "MKEY_GUI_QUERY_PERSON";                            	// Person*
const std::string MKEY_BL_QUERY_PERSON = "MKEY_BL_QUERY_PERSON";                              	// Person*
const std::string MKEY_DB_QUERY_PERSON = "MKEY_DB_QUERY_PERSON";                              	// PersonVector*  (see drctypes.h)
...
const std::string MKEY_DB_QUERY_MEDIATION = "MKEY_DB_QUERY_MEDIATION";                          // MediationProcessVector*  (see drctypes.h)
